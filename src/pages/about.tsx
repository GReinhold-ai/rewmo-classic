  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about RewmoAI — rewards, training, and Lean Lab."
        />
      </Head>
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 text-white">
        <header className="mb-8">
          ...
          <p className="mt-2 text-white/80">
            Rewards + practical training to help you save money, improve processes,
            and grow skills.
          </p>
        </header>
        ...
        <section className="space-y-4">
          ...
          <p className="text-white/85">
            RewmoAI is building an easy on-ramp to smarter personal finance, GenAI
            skills, and practical process improvement (R-PM / Lean Lab). Earn
            rewards while you learn, connect your everyday shopping, and unlock
        ...
        <section className="mt-8 space-y-4">
          ...
          <p className="text-white/85">We offer short, hands-on modules across three tracks:</p>
        ...
        <section className="mt-8 space-y-4">
          ...
          <p className="text-white/85">
            ...
            ). Your activity accrues points during beta; withdrawals open after
            launch.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-4">
          ...
          <p className="text-white/85">
            ...
            <ExternalLink href="mailto:support@rewmo.ai">support@rewmo.ai</ExternalLink> or
            connect with us on <ExternalLink href="https://www.linkedin.com/">LinkedIn</ExternalLink>.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-2 text-white/85">
            <li>
              Icons by <ExternalLink href="https://lucide.dev/">Lucide</ExternalLink>.
            </li>
            <li>
              Charts by <ExternalLink href="https://recharts.org/en-US/">Recharts</ExternalLink>.
            </li>
            <li>
              UI built with <ExternalLink href="https://nextjs.org/">Next.js</ExternalLink> and
              Tailwind CSS.
            </li>
          </ul>
        </section>
